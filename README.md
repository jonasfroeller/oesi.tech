...
| Rank | Project        | Author            | Stars | Language   | Description                          | Repo                   |
| ---- | -------------- | ----------------- | ----- | ---------- | ------------------------------------ | ---------------------- |
| 1    | OpenClaw       | Peter Steinberger | 290k  | TypeScript | Personal local AI agent assistant    | openclaw/openclaw      |
| 2    | Flask          | Armin Ronacher    | 71.3k | Python     | Python web microframework            | pallets/flask          |
| 3    | MPAndroidChart | Philipp Jahoda    | 38.2k | Java       | Android charting library             | PhilJay/MPAndroidChart |
